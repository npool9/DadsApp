...
import com.nathanpool.youtubeview.YouTubePlayerView;
import com.nathanpool.youtubeview.models.ImageLoader;
import com.nathanpool.updatepanel.helper.Constants;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;

public class YouTubePlayerAdapter extends RecyclerView.Adapter<YouTubePlayerAdapter
    ...
    private ImageLoader imageLoader = new ImageLoader() {
        ...
        public void loadImage(@NonNull ImageView imageView, @NonNull String url, int height, int width) {
            Picasso.with(imageView.getContext()).load(url).resize(width,
    ...
    public YouTubePlayerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.youtube_player,
                parent, false);
    ...
    public void onBindViewHolder(@NonNull final YouTubePlayerViewHolder holder, int position) {
        ...
        playerView.initPlayer(Constants.API_KEY, videoId, "https://cdn.rawgit.com/" +
                        "flipkart-incubator/inline-youtube-view/60bae1a1/youtube-android/youtube" +
                        "_iframe_player.html", playerType, null, fragment, imageLoader);
    }
